...
export const TsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M9 10h4" />
        <path d="M11 10v6" />
        <path d="M17 10a2 2 0 0 1-2 2h-1a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h1a2 2 0 0 1 2-2" />
    </svg>
);
...
export const BugIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 20c-3.3 0-6-2.7-6-6v-4c0-3.3 2.7-6 6-6s6 2.7 6 6v4c0 3.3-2.7 6-6 6z"/>
        <path d="m18.7 11.3-1.4-1.4"/>
        <path d="m5.3 11.3 1.4-1.4"/>
        <path d="M12 22v-2"/>
        <path d="M12 2v2"/>
        <path d="M22 12h-2"/>
        <path d="M4 12H2"/>
        <path d="m18.7 12.7 1.4 1.4"/>
        <path d="m5.3 12.7-1.4 1.4"/>
    </svg>
);